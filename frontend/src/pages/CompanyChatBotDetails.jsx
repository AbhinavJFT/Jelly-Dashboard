        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center justify-center  gap-3">
            ...
            <div className="flex flex-col items-center justify-center text-black">
              ...
              <span className="text-[#737787] text-sm font-bold">
                {chatbot?.origin_url}
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-black">
            ...
            <span className="text-[#908A8A] text-sm font-bold">Total input tokens</span>
          </div>
          <div className="flex flex-col items-center justify-center text-black">
            <span className="text-[#737787] font-bold text-2xl">
              {chatbot?.total_output_tokens}
            </span>
            <span className="text-[#908A8A] text-sm font-bold">Total Output Tokens</span>
          </div>
          <div className="flex flex-col items-center justify-center text-black">
            <span className="text-[rgb(115,119,135)] font-bold text-2xl">
              {roundToThreeDecimals(chatbot?.input_token_cost)}
            </span>
            
            <span className="text-[#908A8A] text-sm font-bold">Input Token Cost</span>
          </div>
          <div className="flex flex-col items-center justify-center text-black">
            <span className="text-[#737787] font-bold text-2xl">
              {roundToThreeDecimals(chatbot?.output_token_cost)}
            </span>
            <span className="text-[#908A8A] text-sm font-bold">Output Token Cost</span>
          </div>
        </div>
      </div>
      <div className="mt-[2rem] flex flex-col">
        ...
        <ChatBotQueryTable queries={queries} company={company} chatbot={chatbot}/>
      </div>
    </div>
  );
};
