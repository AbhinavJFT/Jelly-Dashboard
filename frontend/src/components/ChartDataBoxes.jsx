  ...
  return (
    <div className="h-auto mt-[2rem] flex gap-5 ">
      <div className=" h-full w-[50%] rounded-md bg-white h-[25rem] flex flex-col items-center">
        <div className="text-2xl text-[#767B8B] font-bold mt-[1.5rem] mb-[1rem]  flex w-full items-center justify-between  ">
          <p className="ml-[12rem]">QUERIES BY COMPANIES</p>
          <div
            className="mr-[1rem] mt-[-2rem] cursor-pointer"
            onClick={() =>
              navigate('/company/queries', { state: { companies: companies } })
            }
          >
            <ExpandIcon />
          </div>
      ...
      <div className=" h-full w-[50%] rounded-md bg-white h-[25rem] flex flex-col items-center">
        <div className="text-2xl text-[#767B8B] font-bold mt-[1.5rem] mb-[1rem]  flex w-full items-center justify-between  ">
          <p className="ml-[12rem]">COMPANY WISE COSTING ($)</p>
          <div
            className="mr-[1rem] mt-[-2rem] cursor-pointer"
            onClick={() =>
              navigate('/company/costings', { state: { companies: companies } })
            }
          >
            <ExpandIcon />
          </div>
